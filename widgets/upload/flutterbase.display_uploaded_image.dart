...
/// 업로드된 사진을 표시
///
class FlutterbaseDisplayUploadedImages extends StatefulWidget {
  /// [doc] 사용자 도큐먼트
  ...
  @override
  _FlutterbaseDisplayUploadedImagesState createState() =>
      _FlutterbaseDisplayUploadedImagesState();
}

class _FlutterbaseDisplayUploadedImagesState
    extends State<FlutterbaseDisplayUploadedImages> {
  @override
  ...
  Widget build(BuildContext context) {
    ...
    return MaterialButton(
      onPressed: () async {
        ...
        try {
          await FlutterbaseStorage(widget.doc).delete(widget.url);
        } catch (e) {
          // print(e);
          alert(e);
        }
