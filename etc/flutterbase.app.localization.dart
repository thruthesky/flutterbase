import './flutterbase.texts.dart';
import 'package:flutter/foundation.dart';
import 'package:flutter/material.dart';

/// 디바이스의 설정에 따라 여러 언어로 쓸 수 있도록 해 준다.
/// 
/// 대부분의 앱에서 `Localization` 설정이 비슷한데, 만약 별도의 `Localization`이 필요하면 직접 만들어 써도 된다.
/// `Localization`은 사실 `Engine`의 핵심 기능과는 상관 없는 `Helper Class`라고 보면 된다. 
